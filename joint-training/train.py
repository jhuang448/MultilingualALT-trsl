...
class ASR(sb.core.Brain):
    def compute_forward(self, batch, stage):
        ...
        enc_out, pred = self.modules.Transformer(
            src, tokens_bos, wav_lens, pad_idx=self.hparams.pad_index # film2
        )
        ...
        if stage == sb.Stage.TRAIN:
            ...
            hyps_reg, _ = self.hparams.test_search(enc_out.detach(), wav_lens)
            # hyps_LM, _ = self.hparams.test_search_LM(enc_out.detach(), wav_lens)
            hyps_LM = None
